...
const InventoryPage = () => {
  ...
  const jetSkiInventory = [
    {
      ...
      features: ['Supercharged Engine', 'Racing Performance', 'Professional Grade', 'GPS', 'Bluetooth'],
      description: 'The ultimate high-performance watercraft designed for racing and thrill-seekers.',
      condition: 'Like New',
    ...
    },
    {
      ...
      features: ['Luxury Touring', 'Extended Range', 'Comfort Package', 'Storage', 'GPS'],
      description: 'Perfect for long-distance touring with comfort and luxury features.',
      condition: 'Excellent',
    ...
    },
    {
      ...
      seating: '1-3 Passengers',
      features: ['310HP Supercharged', 'Electronic Steering', 'Launch Control', 'Trim System'],
      description: 'Powerful supercharged performance with advanced handling technology.',
      condition: 'New',
      location: 'Toronto Showroom'
    },
    {
      ...
      features: ['Lightweight Design', 'Fuel Efficient', 'Easy Handling', 'Tow Sports'],
      description: 'Fun and affordable entry-level jet ski perfect for families.',
      condition: 'Good',
    ...
    },
    {
      ...
      seating: '1-3 Passengers',
      features: ['Reverse & Neutral', 'Cruise Control', 'Security System', 'Storage'],
      description: 'Reliable recreation watercraft with premium features and comfort.',
      condition: 'Excellent',
      location: 'Toronto Showroom'
    },
    {
      ...
      seating: '1-3 Passengers',
      features: ['160HP Engine', 'Smart Steering', 'Dual Mirrors', 'Tow Sports'],
      description: 'Versatile recreation jet ski with great performance and value.',
      condition: 'Good',
      location: 'Mississauga Showroom'
    }
  ];
  ...
  const filteredAndSortedInventory = jetSkiInventory
    .filter(jetski => {
      const matchesSearch = jetski.model.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           jetski.brand.toLowerCase().includes(searchTerm.toLowerCase());
      const matchesBrand = selectedBrand === 'all' || jetski.brand === selectedBrand;
      const matchesType = selectedType === 'all' || jetski.type === selectedType;

      let matchesPrice = true;
      if (priceRange === 'under-10k') matchesPrice = jetski.price < 10000;
      else if (priceRange === '10k-15k') matchesPrice = jetski.price >= 10000 && jetski.price < 15000;
      else if (priceRange === '15k-20k') matchesPrice = jetski.price >= 15000 && jetski.price < 20000;
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case 'hours-low': return a.hours - b.hours;
        default: return 0;
      }
    });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Browse our extensive collection of premium jet skis. From high-performance racing models
            to family-friendly recreation watercraft, find your perfect ride on the water.
          </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-gray-600">
            Showing {filteredAndSortedInventory.length} of {jetSkiInventory.length} jet skis
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredAndSortedInventory.map(jetski => (
            <div key={jetski.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              {/* Image */}
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <span className={`px-3 py-1 rounded-full text-sm font-semibold text-white ${
                    jetski.condition === 'New' ? 'bg-green-600' :
                    jetski.condition === 'Like New' ? 'bg-blue-600' :
                    jetski.condition === 'Excellent' ? 'bg-yellow-600' : 'bg-gray-600'
                  }`}>
                    {jetski.condition}
                  </span>
                </div>
              ...
              <div className="p-6">
                <div className="mb-2">
                  <span className="text-sm text-blue-600 font-semibold">{jetski.type}</span>
                </div>
        ...
        {filteredAndSortedInventory.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No jet skis found</h3>
        ...
        <div className="mt-16 bg-blue-600 rounded-lg p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6">
            We get new inventory weekly and can help you find the perfect jet ski for your needs.
          </p>
