  ...
  const benefits = [
    {
      ...
      description:
        "Good credit, bad credit, or no credit - we work with everyone",
    },
    {
      icon: Shield,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              All types of credit, from good to bad, can qualify for a jet ski
              loan. No credit, no problem! We will work with you to secure a no
              credit jet ski loan if your situation demands it. Aqua Motors has
              strong relationships and is committed to finding you the perfect
              loan company to suit your financing needs.
            </p>
            <p className="text-lg text-gray-600 mb-8">
              Low interest jet ski loans are available for customers with
              existing loans. We can help you refinance your loan or adjust the
              term of the contract. You're just a step away from approved jet
              ski financing!
            </p>
        ...
        <div className="mt-16 bg-gray-900 rounded-lg p-8 md:p-12 text-center">
          ...
          <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
            Don't let financing hold you back from your dream jet ski. Our
            finance team is here to help you navigate the process and get you
            approved quickly.
          </p>
